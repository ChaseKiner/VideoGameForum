...
echo $sql = "Select * from videogames where  " . $rating_filter . " and franchise = '" . $franchise . "' and game_modes = '" . $game_modes . "' and genres = '" . $genres . "' and popularity = '" . $popularity . " LIMIT 1'";
